...
WebUI.callTestCase(findTestCase('Pages/QA-Audyna/Filter - Audyna/Click Home'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/QA-Audyna/Filter - Audyna/Click Filter for Computer and Accessory'), [:], FailureHandling.OPTIONAL)
