...
WebUI.callTestCase(findTestCase('Common - sarah/Start Application'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/User Sell List/Click Daftar Jual'), [:], FailureHandling.STOP_ON_FAILURE)
