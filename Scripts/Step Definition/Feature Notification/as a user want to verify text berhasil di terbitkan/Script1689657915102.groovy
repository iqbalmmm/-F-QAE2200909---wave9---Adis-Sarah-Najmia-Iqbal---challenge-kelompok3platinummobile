...
WebUI.callTestCase(findTestCase('Pages/Notification/Verify text Berhasil di terbitkan'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Common/Close Application'), [:], FailureHandling.STOP_ON_FAILURE)
